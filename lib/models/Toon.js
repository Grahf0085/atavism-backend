...
export class Toon {
  ...
  static async findByName(name) {
    ...
    (SELECT value FROM char_skills WHERE skillid = 48 AND charid = chars.charid) AS fishing,
    (SELECT value FROM char_skills WHERE skillid = 49 AND charid = chars.charid) AS woodworking,
    (SELECT value FROM char_skills WHERE skillid = 50 AND charid = chars.charid) AS smithing,
    (SELECT value FROM char_skills WHERE skillid = 51 AND charid = chars.charid) AS goldsmithing,
    (SELECT value FROM char_skills WHERE skillid = 52 AND charid = chars.charid) AS clothcraft,
    (SELECT value FROM char_skills WHERE skillid = 53 AND charid = chars.charid) AS leathercraft,
    (SELECT value FROM char_skills WHERE skillid = 54 AND charid = chars.charid) AS bonecraft,
    (SELECT value FROM char_skills WHERE skillid = 55 AND charid = chars.charid) AS alchemy,
    (SELECT value FROM char_skills WHERE skillid = 56 AND charid = chars.charid) AS cooking,
    race, face, pos_zone,
    ...
    INNER JOIN char_skills ON char_skills.charid = chars.charid
